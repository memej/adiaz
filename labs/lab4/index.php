...
<html>
    ...
    <body>
        <br>
         ...
         <form>
            <input type="text" id = "tex" name="keyword" placeholder="keyword" value="<?=$_GET['keyword']?>"/>
            
            <input type="radio" id="lhorizontal" name="layout" value="horizontal" <?= ($_GET['layout']=='horizontal')?"checked":""  ?> >
            <label for="lhorizontal" id = "horiRadio"> Horizontal </label>
            ...
            <label for="lvertical" id = "vertiRadio"> Vertical </label>
